...
\begin{document}
	...
	\frame{\frametitle {Práticas da Modelagem Ágil - Principais}
	    \begin{enumerate}
	        ...
	        \item Descrição simples do modelo; \pause
	        \item Exponha os modelos publicamente. \pause
	    \end{enumerate}
	}
	...
	\frame{\frametitle {Práticas da Modelagem Ágil - Suplementares}
	    \begin{enumerate}
	        ...
	        \item Atualize somente quando for necessário. \pause
	    \end{enumerate}
	}	
	...
	\frame{\frametitle {Críticas à Modelagem Ágil}
	    \begin{itemize}
	        \item Somente trabalhar com desenvolvedores de nível sênior;
	        \item Incorpora de forma insuficiente o projeto de software;
	        \item Requer a adoção de muita mudança cultural;
	        \item Poder levar a maiores dificuldades nas negociações contratuais.
	    \end{itemize}
	}
